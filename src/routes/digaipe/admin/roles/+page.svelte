...
<style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .banner.error { background: #fff0f0; color: #c0392b; border: 1px solid #fcc; }
    .banner.success { background: #f0faf4; color: #1a7a45; border: 1px solid #b6e8c8; }
    ...
    .badge.admin { background: #0f0f0f; color: #fff; }
    ...
    .toggle-btn.user:hover:not(:disabled) { background: #333; }
    ...
    .toggle-btn.admin:hover:not(:disabled) { background: #fff0f0; }
</style>