...
.container-header-admisiones input, .container-header-admisiones select {
	width: fit-content;
}
...
.button-admisiones, .button-clear-admisiones {
	padding: 1em 1.5em;
	height: 3.5em;
	align-self: end;
	border-radius: 8px;
...
<div class='container-header-admisiones'>
	...
	<div class='container-inputs-admisiones' style='margin-top:1em;'>
		...
		<div class='label-input' style='width: 50%;'>
			...
			<input style='width:100%;' id='buscar' name="search" type="search" value={data.filters.search} />
		</div>
